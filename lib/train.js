...
function train( trainFile = './train.data', modelFile = './out.model', options, callback ) {
	var options = options || {},
			argsArray = [],
			name,
	...
	{
		throw new TypeError( 'trainFile must be string.' );
	}
	if(!_.isString(modelFile))
	{
		throw new TypeError( 'modelFile must be string.' );
	}
